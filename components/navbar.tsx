    ...
    <a href="/" className="flex items-center gap-3 group text-decoration-none">
      ...
      <div className="flex flex-col">
        ...
        <Sheet>
          ...
          <SheetContent side="left" className="md:hidden p-6">
            <SheetHeader>
            ...
            <div className="flex flex-col gap-4">
              {navItems.map((item) => (
                <SheetClose asChild key={item.label}>
                  <Link href={item.href} className="text-base font-medium text-neutral-900">
                    {item.label}
                  </Link>
                </SheetClose>
              ))}
              <SheetClose asChild>
                <Link href="/contact" className="mt-2 inline-flex items-center gap-2 px-4 py-2 bg-neutral-900 text-white text-sm font-medium rounded-full">
                  Contact Us
                </Link>
              </SheetClose>
            </div>
